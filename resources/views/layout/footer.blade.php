...
<footer id="footer">
    <div class="container">
        ...
        <div id="introduce-box" class="row">
            <div class="col-md-3">
                <div id="address-box">
                    <a href="#"><img src="source/assets/images/logo2.png" alt="logo"/></a>
                    <div id="address-list">
        ...
        <div id="trademark-box" class="row">
            <div class="col-sm-12">
                <ul id="trademark-list">
                    ...
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-ups.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-qiwi.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-wu.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-cn.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-visa.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-mc.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-ems.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-dhl.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-fe.jpg" alt="ups"/></a>
                    </li>
                    <li>
                        <a href="#"><img src="source/assets/data/trademark-wm.jpg" alt="ups"/></a>
                    </li>
                </ul>
            </div>
        </div> <!-- /#trademark-box -->
